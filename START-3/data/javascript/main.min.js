...
var d=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(f){d(f,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var f=this.batch_;this.batch_=[];for(var h=0;h<f.length;++h){var k=f[h];f[h]=null;try{k()}catch(m){this.asyncThrow_(m)}}}this.batch_=null};b.prototype.asyncThrow_=function(f){this.asyncExecuteFunction(function(){throw f;})};var e=function(f){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var h=this.createResolveAndReject_();
try{f(h.resolve,h.reject)}catch(k){h.reject(k)}};e.prototype.createResolveAndReject_=function(){function f(m){return function(l){k||(k=!0,m.call(h,l))}}var h=this,k=!1;return{resolve:f(this.resolveTo_),reject:f(this.reject_)}};e.prototype.resolveTo_=function(f){if(f===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(f instanceof e)this.settleSameAsPromise_(f);else{a:switch(typeof f){case "object":var h=null!=f;break a;case "function":h=!0;break a;default:h=!1}h?this.resolveToNonPromiseObj_(f):
...
f.callWhenSettled_(h.resolve,h.reject)};e.prototype.settleSameAsThenable_=function(f,h){var k=this.createResolveAndReject_();try{f.call(h,k.resolve,k.reject)}catch(m){k.reject(m)}};e.prototype.then=function(f,h){function k(p,q){return"function"==typeof p?function(r){try{m(p(r))}catch(t){l(t)}}:q}var m,l,n=new e(function(p,q){m=p;l=q});this.callWhenSettled_(k(f,m),k(h,l));return n};e.prototype.catch=function(f){return this.then(void 0,f)};e.prototype.callWhenSettled_=function(f,h){function k(){switch(m.state_){case 1:f(m.result_);
break;case 2:h(m.result_);break;default:throw Error("Unexpected state: "+m.state_);}}var m=this;null==this.onSettledCallbacks_?g.asyncExecute(k):this.onSettledCallbacks_.push(k);this.isRejectionHandled_=!0};e.resolve=c;e.reject=function(f){return new e(function(h,k){k(f)})};e.race=function(f){return new e(function(h,k){for(var m=$jscomp.makeIterator(f),l=m.next();!l.done;l=m.next())c(l.value).callWhenSettled_(h,k)})};e.all=function(f){var h=$jscomp.makeIterator(f),k=h.next();return k.done?c([]):new e(function(m,
...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var m=Object.seal({}),l=Object.seal({}),n=new a([[m,2],[l,3]]);if(2!=n.get(m)||3!=n.get(l))return!1;n.delete(m);n.set(l,4);return!n.has(m)&&4==n.get(l)}catch(p){return!1}}function c(){}function d(m){var l=typeof m;return"object"===l&&null!==m||"function"===l}function e(m){if(!$jscomp.owns(m,f)){var l=new c;$jscomp.defineProperty(m,f,{value:l})}}function g(m){if(!$jscomp.ISOLATE_POLYFILLS){var l=Object[m];l&&(Object[m]=
function(n){if(n instanceof c)return n;Object.isExtensible(n)&&e(n);return l(n)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var h=0,k=function(m){this.id_=(h+=Math.random()+1).toString();if(m){m=$jscomp.makeIterator(m);for(var l;!(l=m.next()).done;)l=l.value,this.set(l[0],l[1])}};k.prototype.set=function(m,l){if(!d(m))throw Error("Invalid WeakMap key");
e(m);if(!$jscomp.owns(m,f))throw Error("WeakMap key fail: "+m);m[f][this.id_]=l;return this};k.prototype.get=function(m){return d(m)&&$jscomp.owns(m,f)?m[f][this.id_]:void 0};k.prototype.has=function(m){return d(m)&&$jscomp.owns(m,f)&&$jscomp.owns(m[f],this.id_)};k.prototype.delete=function(m){return d(m)&&$jscomp.owns(m,f)&&$jscomp.owns(m[f],this.id_)?delete m[f][this.id_]:!1};return k},"es6","es3");$jscomp.MapEntry=function(){};
...
e(this,k).entry)&&k.value};d.prototype.entries=function(){return g(this,function(k){return[k.key,k.value]})};d.prototype.keys=function(){return g(this,function(k){return k.key})};d.prototype.values=function(){return g(this,function(k){return k.value})};d.prototype.forEach=function(k,m){for(var l=this.entries(),n;!(n=l.next()).done;)n=n.value,k.call(m,n[1],n[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var e=function(k,m){var l=m&&typeof m;"object"==l||"function"==l?c.has(m)?l=c.get(m):
(l=""+ ++h,c.set(m,l)):l="p_"+m;var n=k.data_[l];if(n&&$jscomp.owns(k.data_,l))for(k=0;k<n.length;k++){var p=n[k];if(m!==m&&p.key!==p.key||m===p.key)return{id:l,list:n,index:k,entry:p}}return{id:l,list:n,index:-1,entry:void 0}},g=function(k,m){var l=k.head_;return $jscomp.iteratorPrototype(function(){if(l){for(;l.head!=k.head_;)l=l.previous;for(;l.next!=l.head;)return l=l.next,{done:!1,value:m(l)};l=null}return{done:!0,value:void 0}})},f=function(){var k={};return k.previous=k.next=k.head=k},h=0;
return d},"es6","es3");
...
*/
(function(){for(var a=0,b=["webkit","moz"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(d){var e=(new Date).getTime(),g=Math.max(0,16.7-(e-a)),f=window.setTimeout(function(){d(e+g)},g);a=e+g;return f});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(d){clearTimeout(d)})})();
global.isBelowIE9()||!function(a,b){"object"==typeof exports&&"object"==typeof module?module.exports=b():"function"==typeof define&&define.amd?define([],b):"object"==typeof exports?exports.ClipboardJS=b():a.ClipboardJS=b()}(this,function(){return function(a){function b(d){if(c[d])return c[d].exports;var e=c[d]={i:d,l:!1,exports:{}};return a[d].call(e.exports,e,e.exports,b),e.l=!0,e.exports}var c={};return b.m=a,b.c=c,b.i=function(d){return d},b.d=function(d,e,g){b.o(d,e)||Object.defineProperty(d,
e,{configurable:!1,enumerable:!0,get:g})},b.n=function(d){var e=d&&d.__esModule?function(){return d.default}:function(){return d};return b.d(e,"a",e),e},b.o=function(d,e){return Object.prototype.hasOwnProperty.call(d,e)},b.p="",b(b.s=3)}([function(a,b,c){var d,e,g;!function(f,h){e=[a,c(7)];d=h;void 0!==(g="function"==typeof d?d.apply(b,e):d)&&(a.exports=g)}(0,function(f,h){var k=h&&h.__esModule?h:{default:h},m="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:
...
if("cut"===this.action&&(p.hasAttribute("readonly")||p.hasAttribute("disabled")))throw Error('Invalid "target" attribute. You can\'t cut text from elements with "readonly" or "disabled" attributes');this._target=p}},get:function(){return this._target}}]),n}();f.exports=h})},function(a,b,c){function d(h,k,m){return h.addEventListener(k,m),{destroy:function(){h.removeEventListener(k,m)}}}function e(h,k,m){return Array.prototype.forEach.call(h,function(l){l.addEventListener(k,m)}),{destroy:function(){Array.prototype.forEach.call(h,
function(l){l.removeEventListener(k,m)})}}}var g=c(6),f=c(5);a.exports=function(h,k,m){if(!h&&!k&&!m)throw Error("Missing required arguments");if(!g.string(k))throw new TypeError("Second argument must be a String");if(!g.fn(m))throw new TypeError("Third argument must be a Function");if(g.node(h))return d(h,k,m);if(g.nodeList(h))return e(h,k,m);if(g.string(h))return f(document.body,h,k,m);throw new TypeError("First argument must be a String, HTMLElement, HTMLCollection, or NodeList");}},function(a,
b){function c(){}c.prototype={on:function(d,e,g){var f=this.e||(this.e={});return(f[d]||(f[d]=[])).push({fn:e,ctx:g}),this},once:function(d,e,g){function f(){h.off(d,f);e.apply(g,arguments)}var h=this;return f._=e,this.on(d,f,g)},emit:function(d){var e=[].slice.call(arguments,1),g=((this.e||(this.e={}))[d]||[]).slice(),f=0,h=g.length;for(f;f<h;f++)g[f].fn.apply(g[f].ctx,e);return this},off:function(d,e){var g=this.e||(this.e={}),f=g[d],h=[];if(f&&e)for(var k=0,m=f.length;k<m;k++)f[k].fn!==e&&f[k].fn._!==
e&&h.push(f[k]);return h.length?g[d]=h:delete g[d],this}};a.exports=c},function(a,b,c){var d,e,g;!function(f,h){e=[a,c(0),c(2),c(1)];d=h;void 0!==(g="function"==typeof d?d.apply(b,e):d)&&(a.exports=g)}(0,function(f,h,k,m){function l(w){return w&&w.__esModule?w:{default:w}}function n(w,v){if("function"!=typeof v&&null!==v)throw new TypeError("Super expression must either be null or a function, not "+typeof v);w.prototype=Object.create(v&&v.prototype,{constructor:{value:w,enumerable:!1,writable:!0,
...
8;a<this.moduleCount-8;a++)null==this.modules[a][6]&&(this.modules[a][6]=0==a%2);for(a=8;a<this.moduleCount-8;a++)null==this.modules[6][a]&&(this.modules[6][a]=0==a%2)},setupPositionAdjustPattern:function(){for(var a=QRUtil.getPatternPosition(this.typeNumber),b=0;b<a.length;b++)for(var c=0;c<a.length;c++){var d=a[b],e=a[c];if(null==this.modules[d][e])for(var g=-2;2>=g;g++)for(var f=-2;2>=f;f++)this.modules[d+g][e+f]=-2==g||2==g||-2==f||2==f||0==g&&0==f?!0:!1}},setupTypeNumber:function(a){for(var b=
...
c-1]=d:9>c?this.modules[8][15-c-1+1]=d:this.modules[8][15-c-1]=d;this.modules[this.moduleCount-8][8]=!a},mapData:function(a,b){for(var c=-1,d=this.moduleCount-1,e=7,g=0,f=this.moduleCount-1;0<f;f-=2)for(6==f&&f--;;){for(var h=0;2>h;h++)if(null==this.modules[d][f-h]){var k=!1;g<a.length&&(k=1==(a[g]>>>e&1));QRUtil.getMask(b,d,f-h)&&(k=!k);this.modules[d][f-h]=k;e--;-1==e&&(g++,e=7)}d+=c;if(0>d||this.moduleCount<=d){d-=c;c=-c;break}}}};QRCode.PAD0=236;QRCode.PAD1=17;
...
QRCode.createBytes=function(a,b){for(var c=0,d=0,e=0,g=Array(b.length),f=Array(b.length),h=0;h<b.length;h++){var k=b[h].dataCount,m=b[h].totalCount-k;d=Math.max(d,k);e=Math.max(e,m);g[h]=Array(k);for(var l=0;l<g[h].length;l++)g[h][l]=255&a.buffer[l+c];c+=k;l=QRUtil.getErrorCorrectPolynomial(m);k=(new QRPolynomial(g[h],l.getLength()-1)).mod(l);f[h]=Array(l.getLength()-1);for(l=0;l<f[h].length;l++)m=l+k.getLength()-f[h].length,f[h][l]=0<=m?k.get(m):0}for(l=h=0;l<b.length;l++)h+=b[l].totalCount;a=Array(h);
for(l=c=0;l<d;l++)for(h=0;h<b.length;h++)l<g[h].length&&(a[c++]=g[h][l]);for(l=0;l<e;l++)for(h=0;h<b.length;h++)l<f[h].length&&(a[c++]=f[h][l]);return a};
...
case QRMode.MODE_ALPHA_NUM:return 13;case QRMode.MODE_8BIT_BYTE:return 16;case QRMode.MODE_KANJI:return 12;default:throw Error("mode:"+a);}else throw Error("type:"+b);},getLostPoint:function(a){for(var b=a.getModuleCount(),c=0,d=0;d<b;d++)for(var e=0;e<b;e++){for(var g=0,f=a.isDark(d,e),h=-1;1>=h;h++)if(!(0>d+h||b<=d+h))for(var k=-1;1>=k;k++)0>e+k||b<=e+k||(0!=h||0!=k)&&f==a.isDark(d+h,e+k)&&g++;5<g&&(c+=3+g-5)}for(d=0;d<b-1;d++)for(e=0;e<b-1;e++)if(g=0,a.isDark(d,e)&&g++,a.isDark(d+1,e)&&g++,a.isDark(d,
...
QRRSBlock.getRSBlocks=function(a,b){var c=QRRSBlock.getRsBlockTable(a,b);if(void 0==c)throw Error("bad rs block @ typeNumber:"+a+"/errorCorrectLevel:"+b);a=c.length/3;b=[];for(var d=0;d<a;d++)for(var e=c[3*d],g=c[3*d+1],f=c[3*d+2],h=0;h<e;h++)b.push(new QRRSBlock(g,f));return b};
...
var c=new Hammer.Manager(this.swiper[0]);c.add(new Hammer.Pan);c.add((new Hammer.Swipe).recognizeWith(c.get("pan")));c.on("panstart panmove panend pancancel",this.onPan);c.on("swipe",this.onSwipe);this.bind("mousewheel",this.onMouseWheel);this.bind("pointerdown",function(d){d.stopPropagation()})}.bind(this);this.initDotsEvent=function(){for(var c=this,d=this.dots.length,e=0;e<d;e++){var g=this.dots[e];$(g).attr("index",e);$(g).onTap(function(){c.animateToItem(this.index)})}}.bind(this);this.onDown=
...
var e=function(g,f,h){h=(0,$.easing["easeOut"+h])(null,g,d,c-d,f);g<f?this.moveTo(h):(this.moveTo(h),this.animateInterval.stop())}.bind(this);this.animateInterval=function(g,f){e(g,f,"Sine")}.animation(this,300)}.bind(this);this.animateToCenterItem=function(){var c=this.getCurrentItem();if(c[0]){var d=c.offset(),e=0,g=d.left-this.swiper.offset().left;d=d.top-this.swiper.offset().top;switch(this.direction){case "left":e=-(g+c.width()/2)+this.stageLength/2;break;case "top":e=-(d+c.height()/2)+this.stageLength/
2;break;case "bottom":e=d-this.totalLength+c.height()/2+this.stageLength/2;break;case "right":e=g-this.totalLength+c.width()/2+this.stageLength/2}this.animateToPosition(e)}}.bind(this);this.getCurrentItem=function(){var c=this.swiper.find(".focus.highlight");c[0]||(c=this.swiper.find(".highlight"));return c}.bind(this);this.moveTo=function(c){this.swiper.css(this.direction,c+"px")}.bind(this);this.restrictInBoundary=function(){this.animateInterval&&this.animateInterval.stop();var c=this.getCurrentLength(),
...
jQuery.fn.scroll=function(a,b,c){this.create=function(d,e,g){this.swiper=this.find(".swiper");this.items=this.find(".item");this.progress=this.find(".progress");this.progressBar=this.find(".progressBar");this.EVENT_CANCEL=!1;this.drag=void 0===g||g?!0:!1;this.direction=e;this.swiper.css(e,0);this.progress.css(e,0);this.progressBar.css(e,0);this.refreshData();this.initEvent();this.initProgressEvent()}.bind(this);this.refreshData=function(){this.stageWidth=$(this).width();this.stageHeight=$(this).height();
...
this.onPan(d))}.bind(this);this.onProgressSwipe=function(d){this.EVENT_CANCEL||(d.velocityX=-d.velocityX*this.totalLength/this.stageLength,d.velocityY=-d.velocityY*this.totalLength/this.stageLength,this.onSwipe(d))}.bind(this);this.onProgressTap=function(d){if(!this.EVENT_CANCEL&&d&&d.pointers&&1==d.pointers.length){var e=this.progress.offset(),g=0;switch(this.direction){case "left":g=-(d.pointers[0].pageX-e.left)*this.totalLength/this.stageLength;break;case "right":g=-(this.stageLength-d.pointers[0].pageX+
e.left)*this.totalLength/this.stageLength;break;case "top":g=-(d.pointers[0].pageY-e.top)*this.totalLength/this.stageLength;break;case "bottom":g=-(this.stageLength-d.pointers[0].pageY+e.top)*this.totalLength/this.stageLength}this.animateToPosition(g)}}.bind(this);this.onMouseWheel=function(d){if(!this.EVENT_CANCEL){d=d.originalEvent;var e=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));if(!this.animateInterval||this.animateInterval.stopFlag)return e=this.getCurrentLength()+(0>e?-50:50),e=this.getEffectiveLength(e),
this.moveTo(e),d.stopPropagation(),!1}}.bind(this);this.getLeft=function(){return parseInt(this.swiper.css("left"))}.bind(this);this.getRight=function(){return parseInt(this.swiper.css("right"))}.bind(this);this.getBottom=function(){return parseInt(this.swiper.css("bottom"))}.bind(this);this.getTop=function(){return parseInt(this.swiper.css("top"))}.bind(this);this.animateToPosition=function(d){var e=this.getCurrentLength();d=this.getEffectiveLength(d);var g=function(f,h,k){k=(0,$.easing["easeOut"+
k])(null,f,e,d-e,h);f<h?this.moveTo(k):(this.moveTo(k),this.animateInterval.stop())}.bind(this);this.animateInterval=function(f,h){g(f,h,"Sine")}.animation(this,300)}.bind(this);this.animateToCenterItem=function(){var d=this.getCurrentItem();if(d[0]){var e=d.offset(),g=0,f=e.left-this.swiper.offset().left;e=e.top-this.swiper.offset().top;switch(this.direction){case "left":g=-(f+d.width()/2)+this.stageLength/2;break;case "top":g=-(e+d.height()/2)+this.stageLength/2;break;case "bottom":g=e-this.totalLength+
d.height()/2+this.stageLength/2;break;case "right":g=f-this.totalLength+d.width()/2+this.stageLength/2}this.animateToPosition(g)}}.bind(this);this.getCurrentItem=function(){var d=this.swiper.find(".focus.highlight");d[0]||(d=this.swiper.find(".highlight"));return d}.bind(this);this.moveTo=function(d){var e=this.direction;this.swiper.css(e,d+"px");this.progressBar.css(e,-d*this.stageLength/this.totalLength+"px")}.bind(this);this.getCurrentLength=function(){switch(this.direction){case "left":return this.getLeft();
...
function searchFromPages(a,b){var c=[];b=b.trim().toLowerCase();b=-1==b.indexOf(" ")?[b]:b.split(" ");var d;for(d=0;d<a.length;d++){var e=a[d].trim().replace(/[\r\n]/g," "),g=a[d].trim().toLowerCase().replace(/[\r\n]/g," "),f=g,h=-1,k=-1,m=-1,l=0,n=!0,p;for(p=0;p<b.length;p++)if(b[p]){f=new KMP(f,b[p]);var q=b[p].length;if(f.match()){var r=l+f.getIndex();if(r>m)m=r,l=r+b[p].length,f=g.substring(l),0==p&&(h=r),p==b.length-1&&(k=r+q);else{n=!1;break}}else{n=!1;break}}n&&(m=[],l=getHighlightRealPageIndex(d),
0>l||(m.search_page=l+1,m.search_title="page "+(l+1),h=g.substring(0,h).lastIndexOf("."),-1==h?h=0:h++,g=g.substring(k),l=g.indexOf(". "),l=-1==l?k+g.length:k+l+1,e=e.substring(h,l),m.search_text=e,c.push(m)))}return c}function getSearchRealPageIndex(a){if(!window.search_pages||void 0==search_pages[a-1])return a;var b;(a=search_pages[a-1])&&(b=parseInt(a.index));return isNaN(b)||-1==b?-1:b+1}
...
String.prototype.compareTo=function(a){var b=this.length,c=a.length,d=Math.min(b,c),e=this.split("");a=a.split("");var g=0,f=0;if(g==f)for(f=g,d+=g;f<d;){var h=e[f],k=a[f];if(h!=k)return h-k;f++}else for(;0!=d--;)if(h=e[g++],k=a[f++],h!=k)return h-k;return b-c};Class("MediasPool",{currentMedia:null,addToMediasPool:function(a){window.mediasInPage.push(a)},cleanMediaPool:function(a){a.remove();window.mediasInPage.remove(a)}});window.playBackgroundSound=!0;window.mediasInPage=[];
...
var HTMLString={riseAWord:function(a,b,c){b=-1==b.indexOf(" ")?[b]:b.trim().split(" ");for(var d=[],e=0;e<b.length;e++){var g=a.toLowerCase().indexOf(b[e].toLowerCase()),f=g+b[e].length,h=a.substring(0,f);g=a.substring(g,f);a=a.substring(f);h=h.replace(g,"<span style='color:"+c+";'>"+g+"</span>");d.push(h)}""!==a&&d.push(a);return d.join("")},isHTML:function(a){return a?!!a.match(/^(<\w+>?).*((<\/\w+>)|(\/>))$/g):!1},toText:function(a){return"string"!=typeof a?"":a.replace(/<\/?\w+>/g,"")},toLabel:function(a){a=
...
function(){c.width=this.naturalWidth;c.height=this.naturalHeight;c.onResize();c.parent.append(c.leftBotton);c.parent.append(c.rightBotton);bookConfig.isFirstLastShortcutVisible&&(c.parent.append(c.firstButton),c.parent.append(c.lastButton))};this.setButtonIcon()},setButtonIcon:function(){var a=this,b,c,d,e,g,f,h,k,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return b=a.hasColorConfiguration(),c=function(n,p){var q,r,t,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){if(1==
w.nextAddress){if(!b)return w.return(a.getImageUrl(a.getImageMap()[n][p]));q=a.getColorConfiguration(p);r=q.color;t=q.bgColor;u=global.templeteName;return w.yield(a.processImageWithTemplate(n,p,r,t,u),2)}return w.return(w.yieldResult)})},d=$jscomp,e=d.makeIterator,l.yield(Promise.all([c("left","normal"),c("right","normal"),c("left","down"),c("right","down")]),2);g=e.call(d,l.yieldResult);f=g.next().value;h=g.next().value;k=g.next().value;m=g.next().value;a.createButtonIcons(f,h,k,m);l.jumpToEnd()})},
...
b=eval(a)}catch(d){}if(b)for(a=0;a<b.length;a++){var c=b[a];this.fileCookies.push({key:c.key,page:c.page,fileLeft:c.fL,fileTop:c.fT,fileWidth:c.fW,fileHeight:c.fH,imgWidth:c.iW,imgHeight:c.iH,src:c.src});this.imageDatas[c.key]={width:c.iW,height:c.iH}}},addFile:function(a,b){var c=a.src,d=a.imgWidth,e=a.imgHeight,g=a.key;a=$("<div class='flipHTML5AddFile' style='position: absolute;cursor: move;'></div>").css({width:a.fileWidth,height:a.fileHeight,left:a.fileLeft,top:a.fileTop}).attr("data-key",g).append($("<input type='file' class='TextFile' style='position: absolute;left: 0px;top: 0px;width: 100%;height: 100%;cursor: move;z-index: 2;'/>").css({opacity:0})).appendTo(b);
this.bindFileDivEvents(a,b);d&&e&&c&&this.addImage(a,c,d,e,g)},addCreateEvents:function(){var a=0,b,c=this.contextArray;if(c)for(this.offCreateEvents();b=c.eq(a++),0<b.length;)this.bindCreateFileEvent(b,parseInt(b.attr("data-page")))},offCreateEvents:function(){this.contextArray&&(this.contextArray.css({cursor:""}),this.contextArray.off("mousedown.addLocalFile touchstart.addLocalFile"))},bindCreateFileEvent:function(a,b){var c=this;a.css("cursor","crosshair");a.off("mousedown.addLocalFile touchstart.addLocalFile").one("mousedown.addLocalFile touchstart.addLocalFile",
function(d){d.stopPropagation();d.preventDefault();var e=(new Date).getTime(),g,f,h,k,m,l,n=a.offset().left,p=a.offset().top;$(".flipHTML5LocalFile-current").removeClass("flipHTML5LocalFile-current");var q=$("<div style='position: absolute;cursor: move;'></div>").attr("data-key",e).addClass("flipHTML5AddFile flipHTML5LocalFile-current").append($("<input type='file' class='TextFile' style='position: absolute;left: 0px;top: 0px;width: 100%;height: 100%;cursor: move;z-index: 2;'/>").css({opacity:0})).appendTo(a);
var r=g=d.pageX||d.originalEvent.touches[0].pageX;var t=f=d.pageY||d.originalEvent.touches[0].pageY;c.bindFileDivEvents(q,a);$(document).add(a).off("mousemove.addLocalFile touchmove.addLocalFile").on("mousemove.addLocalFile touchmove.addLocalFile",function(u){g=u.pageX?u.pageX:u.originalEvent.touches?u.originalEvent.touches[0].pageX:0;f=u.pageY?u.pageY:u.originalEvent.touches?u.originalEvent.touches[0].pageY:0;g&&(0>g-r?(h=Math.floor((g-n)/BookInfo.scale()),m=Math.floor((r-g)/BookInfo.scale())):(h=
Math.floor((r-n)/BookInfo.scale()),m=Math.floor((g-r)/BookInfo.scale())));f&&(0>u.pageY-t?(k=Math.floor((f-p)/BookInfo.scale()),l=Math.floor((t-f)/BookInfo.scale())):(k=Math.floor((t-p)/BookInfo.scale()),l=Math.floor((f-t)/BookInfo.scale())));q.css({left:h,top:k,width:m,height:l});c.resizeZoomFrame(q)});$(document).add(a).off("mouseup.addLocalFile touchend.addLocalFile").one("mouseup.addLocalFile touchend.addLocalFile",function(u){c.offCreateEvents();$(document).add(a).off("mousemove.addLocalFile touchmove.addLocalFile");
...
addImage:function(a,b,c,d,e){a.find(".LocalImage")&&a.find(".LocalImage").remove();var g=a.width()||40,f=a.height()||40;c=this.resizeImage("autoFit",c,d,g,f);$("<img class='LocalImage' style='position: absolute;z-index: 2;'/>").attr("data-key",e).css({width:c.width,height:c.height,left:c.left,top:c.top}).attr("src",b).appendTo(a)},resizeImage:function(a,b,c,d,e){b/=c;c=0===e?1:d/e;var g=e*b,f=d/b;switch(a){case "autoFit":var h=g>d?{width:d,height:f,top:(e-f)/2,left:0}:f>e?{width:g,height:e,left:(d-
g)/2,top:0}:g/f==b?{width:g,height:f,left:0,top:0}:{width:1,height:1,left:0,top:0};break;case "scale":h={left:0,top:0,width:d,height:e};break;case "fullFill":b>c?h={left:(d-e*b)/2,top:0,width:e*b,height:e}:b<c?h={left:0,top:(e-d/b)/2,width:d,height:d/b}:b==c&&(h={left:0,top:0,width:d,height:e})}return h},bindFileDivEvents:function(a,b){var c=this,d=!1,e=a.attr("data-key");a.on("pointerdown.signatureImg",function(g){g.stopPropagation()});a.off("mousedown.addLocalFile touchstart.addLocalFile").on("mousedown.addLocalFile touchstart.addLocalFile",
function(g){g.preventDefault();g.stopPropagation();g=g.originalEvent.touches?g.originalEvent.touches[0]:g;var f,h;var k=a[0].offsetLeft;var m=a[0].offsetTop;var l=g.pageX;var n=g.pageY;c.resizeZoomFrame(a);b.off("mousemove.addLocalFile touchmove.addLocalFile").on("mousemove.addLocalFile touchmove.addLocalFile",function(p){p=p.originalEvent.touches?p.originalEvent.touches[0]:p;if(3<=Math.abs(p.pageX-l)||3<=Math.abs(p.pageY-n))d=!0;f=k-(l-p.pageX)/BookInfo.scale();h=m-(n-p.pageY)/BookInfo.scale();a.css({left:f,
top:h});c.moveFileDiv(f,h)});$(document).add(b).off("mouseup.addLocalFile touchend.addLocalFile").one("mouseup.addLocalFile touchend.addLocalFile",function(){b.off("mousemove.addLocalFile touchmove.addLocalFile");$(document).add(b).off("mouseup.addLocalFile touchend.addLocalFile");setTimeout(function(){d=!1},200);var p=c.parseObject(a[0]);c.parseObject(c.zoomFrame[0]);c.updateArrayOrderKey(c.fileCookies,e,{fileLeft:p.left,fileTop:p.top});c.addLocalStorage(c.fileName,c.parseJSON(c.fileCookies))})});
a.find(".TextFile").on({change:function(g){try{var f=g.target.files[0];if(f)if(f.type.match("image.*")){var h=new FileReader;h.onload=function(k){k=k.target.result;var m=new Image;m.src=k;var l=m.width;m=m.height;c.imageDatas[e]={width:l,height:m,src:k};c.addImage(a,k,l,m,e);c.updateArrayOrderKey(c.fileCookies,e,{imgWidth:l,imgHeight:m,src:k});c.addLocalStorage(c.fileName,c.parseJSON(c.fileCookies))};h.readAsDataURL(f)}else alert("not image!")}catch(k){alert("Does not support HTML5 FileReader!")}},
click:function(g){d&&g.preventDefault()}})},moveFileDiv:function(a,b){var c=this.zoomFrame;c&&(c.css({left:a-4-1,top:b-4-1}),this.toolBar&&this.toolBar.css({left:c.offset().left-this.container.offset().left+3,top:c.offset().top-this.container.offset().top-this.toolBar.outerHeight()-2}))},resizeZoomFrame:function(a){var b=this.zoomFrame;b.css({width:a.width()+8,height:a.height()+8,left:parseInt(a.css("left"))-4-1,top:parseInt(a.css("top"))-4-1}).show();this.toolBar&&this.toolBar.css({left:a.offset().left-
8-this.container.offset().left+3,top:a.offset().top-8-this.container.offset().top-this.toolBar.outerHeight()-2}).show();a.before(b);$(".flipHTML5LocalFile-current").removeClass("flipHTML5LocalFile-current");this.currentObject=a.addClass("flipHTML5LocalFile-current")},resizeFileDiv:function(a,b,c,d){var e=this.currentObject,g=this.zoomFrame,f=e.attr("data-key");this.toolBar&&this.toolBar&&this.toolBar.css({left:g.offset().left-this.container.offset().left+3,top:g.offset().top-this.container.offset().top-
this.toolBar.outerHeight()-2});if(e){a&&(g.css({left:a}),e.css({left:a+4+1}));b&&(g.css({top:b}),e.css({top:b+4+1}));c&&40<=c&&(g.css({width:c}),e.css({width:c-8}));d&&20<=d&&(g.css({height:d}),e.css({height:d-8}));try{var h=e.find(".LocalImage"),k=this.imageDatas[f],m=this.resizeImage("autoFit",k.width,k.height,e.width(),e.height());h.css({width:m.width,height:m.height,left:m.left,top:m.top})}catch(l){}m=this.parseObject(e[0]);this.parseObject(g[0]);this.updateArrayOrderKey(this.fileCookies,f,{fileLeft:m.left,
fileTop:m.top,fileWidth:m.width,fileHeight:m.height})}},eastZoom:function(a){var b=this,c=a.parent();a.on("mousedown.addLocalFile touchstart.addLocalFile",function(d){d.preventDefault();d.stopPropagation();d=d.originalEvent.touches?d.originalEvent.touches[0]:d;var e=c.parent(),g=c.width(),f=d.pageX;$(document).add(e).on("mousemove.addLocalFile touchmove.addLocalFile",function(h){h=h.originalEvent.touches?h.originalEvent.touches[0]:h;h=Math.floor(g-(f-h.pageX)/BookInfo.scale());b.resizeFileDiv(0,0,
...
d;var e=c.parent(),g=c.height(),f=d.pageY;$(document).add(e).on("mousemove.addLocalFile touchmove.addLocalFile",function(h){h=h.originalEvent.touches?h.originalEvent.touches[0]:h;h=Math.floor(g-(f-h.pageY)/BookInfo.scale());b.resizeFileDiv(0,0,0,h)});$(document).add(e).on("mouseup.addLocalFile touchend.addLocalFile",function(){b.addLocalStorage(b.fileName,b.parseJSON(b.fileCookies));$(document).add(e).off("mousemove.addLocalFile touchmove.addLocalFile");$(document).add(e).off("mouseup.addLocalFile touchend.addLocalFile")})});
return this},westZoom:function(a){var b=this,c=a.parent();a.on("mousedown.addLocalFile touchstart.addLocalFile",function(d){d.preventDefault();d.stopPropagation();d=d.originalEvent.touches?d.originalEvent.touches[0]:d;var e=c.parent(),g=c.width(),f=c[0].offsetLeft,h=d.clientX;$(document).add(e).on("mousemove.addLocalFile touchmove.addLocalFile",function(k){k=k.originalEvent.touches?k.originalEvent.touches[0]:k;var m=f+(k.pageX-h)/BookInfo.scale();k=Math.floor(g+(h-k.pageX)/BookInfo.scale());b.resizeFileDiv(m,
...
d;var e=c.parent(),g=c.height(),f=c[0].offsetTop,h=d.pageY;$(document).add(e).on("mousemove.addLocalFile touchmove.addLocalFile",function(k){k=k.originalEvent.touches?k.originalEvent.touches[0]:k;var m=k.pageY;k=f+(m-h)/BookInfo.scale();m=Math.floor(g+(h-m)/BookInfo.scale());b.resizeFileDiv(0,k,0,m)});$(document).add(e).on("mouseup.addLocalFile touchend.addLocalFile",function(){b.addLocalStorage(b.fileName,b.parseJSON(b.fileCookies));$(document).add(e).off("mousemove.addLocalFile touchmove.addLocalFile");
$(document).add(e).off("mouseup.addLocalFile touchend.addLocalFile")})});return this},bindOnCreated:function(a,b){this.onCreated=[a,b]},parseObject:function(a){if(document.getElementsByTagName("body")[0].contains(a)){var b=a.parentNode;var c=a.style,d=$(a);var e=100/b.offsetHeight;var g=100/b.offsetWidth;b=a.offsetLeft*g+"%";a=a.offsetTop*e+"%";g=d.width()*g+"%";e=d.height()*e+"%";c.width=g;c.height=e;c.left=b;c.top=a;return{width:g,height:e,left:b,top:a}}},addLocalFileByPage:function(a,b){b.find(".flipHTML5AddFile").remove();
...
Class("PageItemFactory",{createItem:function(a,b,c,d,e,g){if(!b)return null;var f=b.annotype,h=null;if(!this.browserSupport(f))return null;g=e+"-"+g;f==PageEditor.AnnoType.ANNO_LINK&&(h=new PageItem.Link(a,b,c,d));if(f==PageEditor.AnnoType.ANNO_YOUTUBE||f==PageEditor.AnnoType.ANNO_YOUTUBE1||f==PageEditor.AnnoType.ANNO_YOUTUBE2||f==PageEditor.AnnoType.ANNO_YOUTUBE3||f==PageEditor.AnnoType.ANNO_YOUTUBE4||f==PageEditor.AnnoType.ANNO_YOUTUBE6||f==PageEditor.AnnoType.ANNO_YOUTUBE7||f==PageEditor.AnnoType.ANNO_YOUTUBE8)h=
isPhone()||isPad()?new PageItem.PopUpVimeo(a,b,c,d,"youtube"):new PageItem.Youtube(a,b,c,d);f==PageEditor.AnnoType.ANNO_YOUTUBE5&&(h=new PageItem.PopUpVimeo(a,b,c,d,"youtube"));f==PageEditor.AnnoType.ANNO_VIMEO&&(h=isPhone()||isPad()?new PageItem.PopUpVimeo(a,b,c,d,"vimeo"):new PageItem.Vimeo(a,b,c,d));f==PageEditor.AnnoType.ANNO_VIMEO2&&(h=new PageItem.PopUpVimeo(a,b,c,d,"vimeo"));f!=PageEditor.AnnoType.ANNO_AUDIO&&f!=PageEditor.AnnoType.ANNO_NEW_AUDIO||b.playerType!=PageEditor.PlayerType.SKIN_3||
(h=new PageItem.Audio(a,b,c,d,"default"));f!=PageEditor.AnnoType.ANNO_AUDIO&&f!=PageEditor.AnnoType.ANNO_NEW_AUDIO||b.playerType!=PageEditor.PlayerType.SKIN_1||(h=new PageItem.Audio(a,b,c,d,"skin1"));f!=PageEditor.AnnoType.ANNO_AUDIO&&f!=PageEditor.AnnoType.ANNO_NEW_AUDIO||b.playerType!=PageEditor.PlayerType.SKIN_2||(h=new PageItem.Audio(a,b,c,d,"skin2"));f==PageEditor.AnnoType.ANNO_AUDIO1&&(h=new PageItem.Audio(a,b,c,d,"advanced"));f==PageEditor.AnnoType.ANNO_AUDIO2&&(h=new PageItem.Audio(a,b,c,
d,"wave"));f==PageEditor.AnnoType.ANNO_AUDIO4&&(h=new PageItem.Audio(a,b,c,d,"background"));if(f==PageEditor.AnnoType.ANNO_PLUGIN&&b.className in audioThemeNames){h=void 0;var k=b.className;k==PageEditor.AudioPlayer.GLASS&&(h="glass");k==PageEditor.AudioPlayer.SIMPLE&&(h="simple");k==PageEditor.AudioPlayer.STANDARD1&&(h="enjoy");k==PageEditor.AudioPlayer.STANDARD2&&(h="decent");k==PageEditor.AudioPlayer.STANDARD3&&(h="tree");k==PageEditor.AudioPlayer.STANDARD4&&(h="christmas");k==PageEditor.AudioPlayer.STANDARD5&&
(h="turnonoff");k==PageEditor.AudioPlayer.STANDARD6&&(h="fade");h=new PageItem.Audio(a,b,c,d,h)}f==PageEditor.AnnoType.ANNO_IMAGE&&(b.imgOriginalProportions||(b.imgOriginalProportions="false"),h=new PageItem.Image(a,b,c,d));f==PageEditor.AnnoType.ANNO_BUTTON&&(h=new PageItem.Button(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_DYNAMICBUTTON&&(h=new PageItem.DynamicButton(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_FLASHSHOW&&(h=new PageItem.FlashShow(a,b,c,d));f==PageEditor.AnnoType.ANNO_HOTSPOTS&&(h=new PageItem.HotSpots(a,
b,c,d));f==PageEditor.AnnoType.ANNO_LINE&&(h=new PageItem.Line(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_ARROW&&(h=new PageItem.Arrow(a,b,c,d));f==PageEditor.AnnoType.ANNO_TRIANGLE&&(h=new PageItem.Triangle(a,b,c,d));f==PageEditor.AnnoType.ANNO_PRISMATIC&&(h=new PageItem.Prismatic(a,b,c,d));f==PageEditor.AnnoType.ANNO_CROSS&&(h=new PageItem.Cross(a,b,c,d));f==PageEditor.AnnoType.ANNO_VIRTUALEND&&(h=new PageItem.VirtualEnd(a,b,c,d));f==PageEditor.AnnoType.ANNO_RIGHTARROW&&(h=new PageItem.RightArrow(a,
b,c,d));f==PageEditor.AnnoType.ANNO_TRAPEZOID&&(h=new PageItem.Trapezoid(a,b,c,d));f==PageEditor.AnnoType.ANNO_DOVETAILED&&(h=new PageItem.Dovetailed(a,b,c,d));f==PageEditor.AnnoType.ANNO_FLOWCHART&&(h=new PageItem.FlowChart(a,b,c,d));f==PageEditor.AnnoType.ANNO_CYLINDER&&(h=new PageItem.Cylinder(a,b,c,d));f==PageEditor.AnnoType.ANNO_PENTAGON&&(h=new PageItem.Pentagon(a,b,c,d));f==PageEditor.AnnoType.ANNO_HEXAGON&&(h=new PageItem.Hexagon(a,b,c,d));f==PageEditor.AnnoType.ANNO_PARALLELOGRAM&&(h=new PageItem.Parallelogram(a,
b,c,d));f==PageEditor.AnnoType.ANNO_ROUND&&(h=new PageItem.Round(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_RECTANGLE&&(h=new PageItem.Rectangle(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_TEXT&&(h=new PageItem.Text(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_ROLLERTEXT&&(h=new PageItem.RollerText(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_AREA&&(h=new PageItem.Area(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_CALLOUT&&(h=new PageItem.Callout(a,b,c,d));f==PageEditor.AnnoType.ANNO_ATEXT&&(h=new PageItem.AText(a,b,c,
d,g));f==PageEditor.AnnoType.ANNO_STARTEXT&&(h=new PageItem.StarText(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_TEXTANIM&&(h=new PageItem.TextAmin(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_ATIMAGE&&(h=new PageItem.PngImage(a,b,c,d));f==PageEditor.AnnoType.ANNO_EFFECTTEXT&&(h=new PageItem.EffectText(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_ADVANCEDSOUND&&(h=new PageItem.Sound(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_CAROUSEL&&(h=new PageItem.Carousel(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_DYNSHOW&&(h=new PageItem.DynamicShow(a,
b,c,d,g));f==PageEditor.AnnoType.ANNO_BANNER&&(h=new PageItem.Banner(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_FLIPJUMP&&(h=new PageItem.FlipJump(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_PLUGIN&&b.className==PLUGIN_MAGNETICS&&(h=new PageItem.FocusJump(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_PLUGIN&&b.className==PLUGIN_ROTATE3D&&(h=new PageItem.Rotate3D(a,b,c,d,g));f==PageEditor.AnnoType.ANNO_VIDEO1&&(h=isPhone()||isPad()?new PageItem.PhoneVideo(a,b,c,d):new PageItem.Video(a,b,c,d,"smallblack"));f==PageEditor.AnnoType.ANNO_VIDEO2&&
(h=isPhone()||isPad()?new PageItem.PhoneVideo(a,b,c,d):new PageItem.LoopControlVideo(a,b,c,d));f==PageEditor.AnnoType.ANNO_PLUGIN&&b.className==PLUGIN_VIDEO1&&(h=isPhone()||isPad()?new PageItem.PhoneVideo(a,b,c,d):new PageItem.Video(a,b,c,d,"classic"));f==PageEditor.AnnoType.ANNO_PLUGIN&&b.className==PLUGIN_VIDEO2&&(h=isPhone()||isPad()?new PageItem.PhoneVideo(a,b,c,d):new PageItem.PopUpVideoItem(a,b,c,d));f==PageEditor.AnnoType.ANNO_VIDEO&&(h=isPhone()||isPad()?new PageItem.PhoneVideo(a,b,c,d):new PageItem.Video(a,
b,c,d,"round"));f==PageEditor.AnnoType.ANNOHTML_VIDEO&&(h=isPhone()||isPad()?new PageItem.PhoneHtmlVideo(a,b,c,d):new PageItem.HtmlVideo(a,b,c,d));f==PageEditor.AnnoType.ANNO_ALPHATRANSITIONBANNER&&(h=new PageItem.AlphaTransitionBanner(a,b,c,d));f==PageEditor.AnnoType.ANNO_EMBEDDEDSLIDESHOW&&(h=new PageItem.EmbeddedSlideshow(a,b,c,d));f==PageEditor.AnnoType.ANNO_PRINT&&(h=new PageItem.Print(a,b,c,d,e));f==PageEditor.AnnoType.ANNO_ZOOM&&(global.popZoomBox||(global.popZoomBox=new PageItem.WindowZoomBox(tmpContainer)),
h=new PageItem.WindowZoom(a,b,c,d,e));f==PageEditor.AnnoType.ANNO_CART&&(h=new PageItem.ShoppingCart(a,b,c,d));return h},browserSupport:function(a){return isBelowIE9()?a==PageEditor.AnnoType.ANNO_LINK||a==PageEditor.AnnoType.ANNO_IMAGE||a==PageEditor.AnnoType.ANNO_TEXT||a==PageEditor.AnnoType.ANNO_ALPHATRANSITIONBANNER?!0:!1:!0}});
Class("PageEditorParser",{create:function(a,b,c){this.container=a;this.containerWidth=b;this.containerHeight=c},createItemsForPage:function(a){var b=new ObjectPool;if(!this.hasProfessional())return b;var c=this.getPageAnnos();if(0>=a||c.length<a||0==c[a-1].length)return b;var d=new PageItemFactory;c=c[a-1];for(var e=0;e<c.length;e++){var g=c[e];g&&(g=d.createItem(this.container,g,this.containerWidth,this.containerHeight,a,e+1))&&b.add(g)}return b},hasProfessional:function(){if(!global.pageEditor&&
...
initEvents:function(){function a(){this.stopFlash();this.link.css({"background-color":d.rgba(this.config.outAlpha)})}var b=this.config.overColor,c=this.config.downColor,d=this.config.outColor,e="";this.config.action&&this.config.action.actionType==PageEditor.ActionType.OPEN_URL&&(e=" url:"+this.config.action.url);this.link.bind(_event._down,function(g){this.stopFlash();bookConfig.googleAnalyticsID&&gtag("event",getEditorEventName()+"click",{event_category:"Link",event_label:"Page"+BookInfo.getCurrentPages()[0]+
" "+e});BookEvent.trigger("clickPageItem",[BookInfo.getCurrentPageIndex(),"Link",this.config.x,this.config.y,this.config.width,this.config.height]);this.link.css({"background-color":c.rgba(this.config.downAlpha)})}.bind(this));this.link.bind(_event._up,function(g){this.stopFlash();this.link.css({"background-color":b.rgba(this.config.overAlpha)})}.bind(this));this.link.bind("mouseenter",function(g){this.stopFlash();parseBool(this.config.mouseOver)&&(this.link.css({"-webkit-box-sizing":"border-box",
...
(function(a){function b(f,h){f=f.querySelectorAll("canvas");var k=h.querySelectorAll("canvas"),m=[];f.forEach(function(l,n){var p=k[n];if(p){p.width=l.width;p.height=l.height;l=l.toDataURL();var q=new Image;n=new Promise(function(r){q.onload=function(){p.getContext("2d").drawImage(q,0,0);r()};q.onerror=function(){return r()}});q.src=l;m.push(n)}});return Promise.all(m).then(function(){})}var c=0,d={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},e={};a.fn.printArea=function(f){a.extend(e,d,f);c++;a("[id^=printArea_]").remove();e.id="printArea_"+c;var h=a(this),k=g.getPrintWindow();g.write(k.doc,h);b(a(this)[0],k.doc).then(function(){function m(){n&&n();g.print(k)}var l=a(k.doc).find("img"),n=f&&"function"===typeof f.onReady?f.onReady:null;if(0===l.length)m();else{var p=0;l.each(function(q,r){if(r.complete)p++,p===l.length&&m();else a(r).on("load error",function(){p++;p===l.length&&
m()})})}})};var g={print:function(f){var h=f.win;a(f.doc).ready(function(){h.focus();h.print();"popup"==e.mode&&e.popClose&&setTimeout(function(){h.close()},2E3)})},write:function(f,h){f.open();f.write(g.docType()+"<html>"+g.getHead()+g.getBody(h)+"</html>");f.close()},docType:function(){return"iframe"==e.mode?"":"html5"==e.standard?"<!DOCTYPE html>":'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01'+("loose"==e.standard?" Transitional":"")+'//EN" "http://www.w3.org/TR/html4/'+("loose"==e.standard?"loose":
"strict")+'.dtd">'},getHead:function(){var f="";e.extraHead&&e.extraHead.replace(/([^,]+)/g,function(h){f+=h});return"<head><title>"+e.popTitle+"</title>"+f+"</head>"},getBody:function(f){var h="",k=e.retainAttr;f.each(function(){for(var m=g.getFormData(a(this)),l="",n=0;n<k.length;n++){var p=a(m).attr(k[n]);p&&(l+=(0<l.length?" ":"")+k[n]+"='"+p+"'")}h+="<div "+l+">"+a(m).html()+"</div>"});return"<body>"+h+"</body>"},getFormData:function(f){var h=f.clone(),k=a("input,select,textarea",h);a("input,select,textarea",
f).each(function(m){var l=a(this).attr("type");"undefined"===a.type(l)&&(l=a(this).is("select")?"select":a(this).is("textarea")?"textarea":"");var n=k.eq(m);"radio"==l||"checkbox"==l?n.attr("checked",a(this).is(":checked")):"text"==l?n.attr("value",a(this).val()):"select"==l?a(this).find("option").each(function(p){a(this).is(":selected")&&a("option",n).eq(p).attr("selected",!0)}):"textarea"==l&&n.text(a(this).val())});return h},getPrintWindow:function(){switch(e.mode){case "iframe":var f=new g.Iframe;
return{win:f.contentWindow||f,doc:f.doc};case "popup":return f=new g.Popup,{win:f,doc:f.doc}}},Iframe:function(){var f=e.id;try{var h=document.createElement("iframe");document.body.appendChild(h);a(h).attr({style:"border:0;position:absolute;width:0px;height:0px;right:0px;top:0px;",id:f,src:"#"+(new Date).getTime()});h.doc=null;h.doc=h.contentDocument?h.contentDocument:h.contentWindow?h.contentWindow.document:h.document}catch(k){throw k+". iframes may not be supported in this browser.";}if(null==h.doc)throw"Cannot find document.";
return h},Popup:function(){var f="location=yes,statusbar=no,directories=no,menubar=no,titlebar=no,toolbar=no,dependent=no,width="+(e.popWd+",height="+e.popHt);f+=",resizable=yes,screenX="+e.popX+",screenY="+e.popY+",personalbar=no,scrollbars=yes";f=window.open("","_blank",f);f.doc=f.document;return f}}})(jQuery);
...
transformCSS(a);this.img.css(b)}this.img.registerPatamers&&this.img.registerParamers(a)}},changeZoomImg:function(){if(this.isZoom){var a=this.img,b=this.img.offset(),c=getTransform(this.img[0]),d=a.parameters.width/a.parameters.naturalWidth,e=this.getSizeConfig(),g=e.width;e=e.height;a.parameters.naturalWidth=g;a.parameters.naturalHeight=e;a.parameters.width=g;a.parameters.height=e;this.img.parameters.scale=d;a.parameters.tran={x:c.x,y:c.y};a.parameters.left=b.left-c.x;a.parameters.top=b.top-c.y;
...
e){var g=d.replace(/<span class='highlight'>|<\/span>/g,"");if(1===g.length){var f=a.indexOf(d);e===b.length-1?"</span>"!==a.slice(f,f-7)&&(c=c.replace(d,g)):"<span"!==a.slice(f+d.length,f+d.length+5)&&(c=c.replace(d,g))}});return c},countHighlightedChars:function(a){this.isSegmentedSearch&&1<bookConfig.leastSearchChar&&(a=this.removeSingleCharHighlight(a));a=a.match(/<span class='highlight'>(.*?)<\/span>/g);if(!a)return 0;var b=0;(1<bookConfig.leastSearchChar?[].concat($jscomp.arrayFromIterable(new Set(a))):
a).forEach(function(c){c=c.replace(/<span class='highlight'>|<\/span>/g,"");b+=c.length});return b},getSearchResult:function(){var a=this,b=this.parm.content.map(function(e){var g=a.countHighlightedChars(e);return{content:e,highlightCount:g}});if(this.isSegmentedSearch&&1<bookConfig.leastSearchChar){var c=b.filter(function(e){return 1<e.highlightCount});c=c.sort(function(e,g){return g.highlightCount-e.highlightCount})}else{var d=this.keyword.length;c=b.filter(function(e){return e.highlightCount===
d});0===c.length&&(c=b.filter(function(e){return 1<e.highlightCount}).sort(function(e,g){return g.highlightCount-e.highlightCount}))}return 0<c.length?HTMLString.toLabel(c[0].content).replaceAll("&lt;br&gt;","<br>").replaceAll("&lt;span class='highlight'&gt;","<span class='highlight'>").replaceAll("&lt;/span&gt;","</span>"):null},handleTap:function(a){var b=this.getSearchIndex(),c=getTarget();(void 0===c.bLink?"":c.bLink)===this.linkName?a.gotoPage&&a.gotoPage(b):(a=this.bookUrl.replace("http://",
"https://")+"?search="+this.keyword+"&match="+this.matchType+"#p="+b,window.open(a,"_blank"))}}).extend(SearchStrategy),AnalysisSearchCorss=Class({create:function(a){var b=this,c=void 0===a.matchType?1:a.matchType,d=void 0===a.callback?function(){}:a.callback;this.keyword=void 0===a.keyword?"":a.keyword;this.matchType=c;this.callback=d;bookConfig.isEncryptionBook&&!BookRestrict.open?("function"==typeof d&&d([],!0),BookEvent.bindEvent("fillBookRestrict",function(e,g){g&&b.getSearchData()})):this.getSearchData()},
...
this;a&&a.length&&a.forEach(function(c,d){c=new SearchBookItem({data:c,parent:b.searchSwiperList,keyword:b.searchText,matchType:b.matchType});c.renderChildren(function(e,g){b.addItem(e,Object.assign({},g,{keyword:b.searchText,isSegmentedSearch:1==b.matchType,matchType:b.matchType}))});b.callBack.expandIconColor&&c.setCloseIconColor(b.callBack.expandIconColor);c.setExpanded(0===d)})},onCorssSearch:function(a,b){b?(this.limitedCallback(),BookEvent.trigger("searchEnd",[a,b])):(this.searchResult.css({display:"none"}),
...
loadSearchFlag=!1,AnalysisSearch=Class({create:function(a,b){this.callback=b;this.results=[];this.search(a)},search:function(a){var b=this,c,d,e,g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:if(0!=loadSearchFlag){b.doSearch(a);h.jumpTo(0);break}return isTouchDevice()?h.yield(getArticleImage(fixURLValue(bookConfig.searchTextJS)),5):(e=d=!1,g=function(){d&&e&&(loadSearchFlag=!0,this.doSearch(a))}.bind(b),h.yield(getArticleImage(fixURLValue(bookConfig.searchTextJS)),
6));case 5:c=h.yieldResult;if(!c)return b.doSearch("",!0),h.return();loadJavascript(c,function(){loadSearchFlag=!0;this.doSearch(a)}.bind(b),function(){loadSearchFlag=!0;this.doSearch(a)}.bind(b));h.jumpTo(0);break;case 6:c=h.yieldResult;if(!c)return b.doSearch("",!0),h.return();loadJavascript(c,function(){d=!0;g()},function(){d=!0;g()});f=String.format(bookConfig.searchPositionJS,BookInfo.getCurrentPageIndex());return h.yield(getArticleImage(fixURLValue(f)),7);case 7:f=h.yieldResult;if(!f)return b.doSearch("",
!0),h.return();loadJavascript(f,function(){e=!0;g()},function(){e=!0;g()});h.jumpToEnd()}})},doSearch:function(a,b){this.results=searchFromPages(textForPages,a);this.callback(this.results,b)},getList:function(){return this.results},clear:function(){this.results=[]}}),SearchItem=Class({create:function(a,b){this.fontColor=b.fontColor;this.parent=a;this.parm=b;this.isCrossBook=b.isCrossBook||!1;this.strategy=this.chooseStrategy(b);this.sDescription=this.strategy.getSearchResult();this.index=this.strategy.getSearchIndex();
...
b){var c=Math.max(a,b);a=this.getSubTextRect(Math.min(a,b));c=this.getSubTextRect(c+1);b=[];b[0]=a[1];b[3]=a[2];b[1]=c[1];b[2]=c[2];return b},getSubTextRect:function(a){var b=[],c=this.leftBottom(),d=this.leftTop(),e=this.getSubTextWidth(a),g=e*this.pageWidth;g=equals(this.line_width.cos(),0)?this.line_width.distance*(a/this.letterCount())/this.pageHeight*this.line_width.sin():g*this.line_width.tan()/this.pageHeight;a=new Point(c.x+e,c.y+g);e=new Point(d.x+e,d.y+g);b[0]=c;b[1]=a;b[2]=e;b[3]=d;return b},
getIndexByPoint:function(a,b){var c=-1;a=this.getPixelPoint(new Point(a,b));var d=this.getPixelPoint(this.leftBottom());b=this.getPixelPoint(this.rightBottom());var e=this.getPixelPoint(this.rightTop()),g=this.getPixelPoint(this.leftTop()),f=new LineABC(d,b);b=new LineABC(b,e);new LineABC(e,g);d=new LineABC(g,d);f=f.distanceFrom(a);e=b.distanceFrom(a);b=b.distanceFrom(a);a=d.distanceFrom(a);if(f<=this.line_height.distance&&e<=this.line_width.distance&&b<=this.line_height.distance&&a<=this.line_width.distance)for(b=
0;b<this.letterCount();){if(this.getSubTextPixelLength(b+1)>=a){c=b;break}b++}return c},getIndexRangeByArea:function(a){var b=-1,c=-1,d=Math.min(a.left,a.right),e=Math.min(a.top,a.bottom),g=Math.max(a.left,a.right);a=Math.max(a.top,a.bottom);for(var f=0;f<this.letterCount();f++){var h=this.getLettersRect(f,f);this.text.substr(f,1);var k=this.getMinX(h);var m=this.getMinY(h);var l=this.getMaxX(h);var n=this.getMaxY(h);h=Math.min(m,n);var p=Math.max(k,l);m=Math.max(m,n);k=Math.min(k,l)>g||p<d||h>a||
m<e;-1==b?k||(c=b=f):k||(c=f)}return-1==b||-1==c?null:{begin:b,end:c}},isSelected:function(a){var b=Math.min(a.left,a.right),c=Math.min(a.top,a.bottom),d=Math.max(a.top,a.bottom);return!(this.box.left>Math.max(a.left,a.right)||this.box.right<b||this.box.top>d||this.box.bottom<c)},isContains:function(a){if(!this.isSelected(a.box))return!1;var b=this.getOverlapArea(a.box);a=Math.min((b.right-b.left)/(a.box.right-a.box.left),(b.bottom-b.top)/(a.box.bottom-a.box.top));return Math.min((b.right-b.left)/
...
this.textItems[b],f=g.posIndex;if(!(g.posIndex+g.letterCount()-1<d)){if(f>a)break;var h=new SearchTextPart(g);h.beginIndex=Math.max(0,d-f);h.endIndex=Math.min(g.letterCount()-1,a-f);e.add(h)}}c.push(e);return a+1},match:function(a,b){var c=this.getTextForSearch(b);if(!c)return!1;a=a.split(" ");for(var d=0;d<a.length;d++){var e=a[d];if(e){c=c.indexOf(e);if(-1==c)return!1;c=this.getTextForSearch(b+c+e.length)}}return!0},getTextForSearch:function(a){var b=this.continuousText.length-a;return 0>=b?"":
this.continuousText.substr(a,b)},select:function(a,b){return b?this.selectByColumnMode(a):this.selectByLineMode(a)},selectByLineMode:function(a){for(var b=new SearchTextResult,c=-1,d=-1,e=0;e<this.itemCount();e++){var g=this.textItems[e];if(g.isSelected(a)){c=e;break}}for(e=this.itemCount()-1;0<=e;)if(g=this.textItems[e],g.isSelected(a)){d=e;break}else e--;if(-1<c&&-1<d)for(e=c;e<=d;e++){g=this.textItems[e];var f=new SearchTextPart(g);f.beginIndex=0;f.endIndex=g.letterCount()-1;if(e==c||e==d){g=g.getIndexRangeByArea(a);
if(!g)continue;e==c&&(f.beginIndex=g.begin);e==d&&(f.endIndex=g.end)}b.add(f)}return b},selectByColumnMode:function(a){for(var b=new SearchTextResult,c=0;c<this.itemCount();c++){var d=this.textItems[c];if(d.isSelected(a)){var e=new SearchTextPart(d);if(d=d.getIndexRangeByArea(a))e.beginIndex=d.begin,e.endIndex=d.end,b.add(e)}}return b}});
...
(b=bookConfig.socialShareLink);var c=getMetaTagValueByName("description"),d=getMetaTagValueByName("keywords");a+="/chatbot/chatbot.php";b=Metacharacter(b);d=Metacharacter(d);c=Metacharacter(c);var e=this.isRtl()?"1":"0",g,f,h=(null==(g=selectedLanguage)?void 0:null==(f=g.language)?void 0:f.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' src='"+(a+"?url="+b+"&desc="+c+"&keyword="+d+"&isRtl="+e+"&lang="+h)+"' ></iframe>");this.container.append(this.chatbotBox);
...
this.handleResize()},setPrompt:function(a){var b=this;a=void 0===a.greeting?"":a.greeting;this.chatBotBtnTips.find("span").text(a);this.getPopupTipsVisible()&&(a=this.chatBotBtn.find("img")[0],a.complete?this.showChatBotBtnTips():a.addEventListener("load",function(){b.showChatBotBtnTips()}))},handleResize:function(){function a(l,n){function p(u){this.isResizing=!0;f=u.center.x;h=u.center.y;k=c.width();m=c.height();switch(n){case "right":c.css({right:"initial",left:u.center.x-k+"px"});break;case "left":c.css({right:"initial",
left:u.center.x+"px"});break;case "top":c.css({bottom:"initial",top:u.center.y+"px"});break;case "bottom":c.css({bottom:"initial",top:u.center.y-m+"px"})}$(l).css({cursor:"move"});d.css({display:"block"});b.frame.css({"box-shadow":"none",border:"none"})}function q(u){if(this.isResizing){var w=Math.min(u.center.x-f,e),v=Math.min(u.center.y-h,g);if(!(u.center.x>e||u.center.y>g||0>u.center.x||0>u.center.y))switch(n){case "right":c.css({width:k+w+"px"});break;case "left":c.css({left:u.center.x+"px",width:k-
...
var q=g.height(),r=e,t=$(r).outerWidth(),u=$(r).outerHeight();r=l.isChatBotBtnTipsVisible?p.x-h:p.x-t/2;p=l.isChatBotBtnTipsVisible?p.y-k:p.y-u/2;r=Math.min(n-t,Math.max(0,r));p=Math.min(q-u,Math.max(0,p));newRight=Math.min(n-r-t,Math.max(n,r));newBottom=Math.min(q-p-u,Math.max(q,p));$(e).css({left:r+"px",top:p+"px",right:"initial",bottom:"initial"});l.chatBotBtnTips[0]&&(n=l.chatBotBtnTips[0].getBoundingClientRect(),l.chatBotBtnTips.css({left:r-n.width-8+"px",right:"initial",bottom:window.innerHeight-
p-m.height+"px"}))}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer"})}var e=a.$el,g=a.parent,f=a.callback;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,k=0,m,l=this;a.on("panstart panmove panend",function(n){n.preventDefault();switch(n.type){case "panstart":b(n);break;case "panmove":c(n);break;case "panend":d(n)}});a.on("tap",function(n){n.preventDefault();f&&f(n)})},hidePopupTips:function(){this.chatBotBtnTips&&(this.isChatBotBtnTipsVisible=!1,this.chatBotBtnTips.fadeOut(),
...
b=Metacharacter(b);d=Metacharacter(d);c=Metacharacter(c);var e=this.isRtl()?"1":"0",g,f,h=(null==(g=selectedLanguage)?void 0:null==(f=g.language)?void 0:f.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' border='0' width='100%' height='100%' src='"+(a+"?url="+b+"&desc="+c+"&keyword="+d+"&isRtl="+e+"&lang="+h)+"' ></iframe>");this.stage.insertBefore(this.parent);this.stage.css({opacity:1,"z-index":"1001",transition:"all 0.3s ease",position:"absolute",
...
(a=textForPages[a])?a.replace(/\r?\n|\r/g,"<br>"):"":""},getReaderTextByIndex:function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){b._readerTextPromise||(b._readerTextPromise={});b._readerTextPromise[a]||(b._readerTextPromise[a]=new Promise(function(d){if(window.readerConfig){var e=function(){if("function"===typeof window.getEditorText)return d(window.getEditorText(a)),!0};if(!e()){var g=function(){e()&&window.eventEmitter.off&&window.eventEmitter.off("initReaderPopDom",
g)};window.eventEmitter.on("initReaderPopDom",g)}}else d([])}));return c.return(b._readerTextPromise[a])})},setTextSection:function(a){var b=this;this.textSection.empty();var c=this._textSectionTaskId=Date.now();a.map(function(d){return b.setTextContentDebounced(d,c)})},setTextContent:function(a,b){var c=this,d,e,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress){if(b!==c._textSectionTaskId)return f.return();d=[];(e=c.getPageTextByIndex(a-1))&&d.push(e);return f.yield(c.getReaderTextByIndex(a-
1),2)}g=f.yieldResult;Array.isArray(g)?d.push.apply(d,$jscomp.arrayFromIterable(g)):g&&d.push(g);if(!d||!d.length)return f.return();d.map(function(h){b===c._textSectionTaskId&&c.appendText(h)});f.jumpToEnd()})},appendText:function(a){var b=this,c=$('<p tabindex="0" aria-live="polite" aria-atomic="true" role="region">'+a+"</p>");c[0].addEventListener("focus",function(){b.textSection[0].scrollTop=c[0].offsetTop});this.textSection.append(c)}});
...
c=BookInfo.getCurrentPages()||1,a.textSectionRenderer.setTextSection(c))})};this._eventBound||(BookEvent.bindOnceEvent("fillBookRestrict",function(c,d){b()}),this._eventBound=!0);b()}catch(c){}},initEvent:function(){var a=this;BookEvent.bindEvent("flipPage",function(b,c,d,e){var g,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){a.pageNum&&a.pageNum.find(".access-dest-page").text(d);g=d.split("-");if(!g||!g.length)return h.return();a.flipPageEvent(g);return h.yield(a.textSectionRenderer.setTextSection(g),
2)}null==(f=a.textSection.find("p")[0])||f.focus();h.jumpToEnd()})});this.closeBtn.on(_event._click,this.hide.bind(this));this.sizeDownBtn.on(_event._click,throttle(this.sizeFontSizeFun.bind(this,!1),300));this.sizeUpBtn.on(_event._click,throttle(this.sizeFontSizeFun.bind(this,!0),300));this.previousPage.on(_event._click,throttle(this.flipPageFun.bind(this,!1),300));this.nextPage.on(_event._click,throttle(this.flipPageFun.bind(this,!0),300));this.handleBoxDrag({$el:this.accessBox[0],parent:this.parent})},
...
Class("PcAccessibility",{handleBoxDrag:function(a){function b(k){this.isDraging=!0;var m=e.getBoundingClientRect();k=k.center;f=k.x-m.x;h=k.y-m.y;$(e).css({cursor:"move"})}function c(k){if(this.isDraging){var m=k.center;k=g.width();var l=g.height(),n=$(e).outerWidth(),p=$(e).outerHeight(),q=m.x-f;m=m.y-h;q=Math.min(k-n,Math.max(0,q));m=Math.min(l-p,Math.max(0,m));$(e).css({bottom:"initial",right:"initial",left:q+"px",top:m+"px"})}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer"})}var e=
a.$el,g=a.parent;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var f=0,h=0;a.on("panstart panmove panend",function(k){k.preventDefault();switch(k.type){case "panstart":b(k);break;case "panmove":c(k);break;case "panend":d(k)}})},show:function(){var a=this;this._super();this._onDocumentClick=this._onDocumentClick||this.handleDocumentClick.bind(this);setTimeout(function(){document.addEventListener("mousedown",a._onDocumentClick,!0)},0)},hide:function(){this._super();this._onDocumentClick&&
...
!0;c.successFun(d)}.bind(this),error:function(d){this.hide();error&&error(d)}.bind(this)})}},successFun:function(a){var b=this.parseLyric(a);b?(this.show(),b&&(this.renderLyric(b),this.updateLyric(b),this.tmp.refreshData(),this.$player.bind("timeupdate",function(){this.updateLyric(b)}.bind(this)))):this.hide()},parseLyric:function(a){var b=a.split("\n"),c=/\[\d*:\d*((\.|:)\d*)*\]/g;if(!a.match(c))return a;a={};for(var d=0;d<b.length;d++){var e=decodeURIComponent(b[d]),g=e.match(c);if(g){e=e.replace(c,
"");for(var f=0,h=g.length;f<h;f++){var k=g[f],m=Number(String(k.match(/\[\d*/i)).slice(1));k=Number(String(k.match(/:\d*/i)).slice(1));a[60*m+k]=e}}}return a},renderLyric:function(a){this.$lyrics.html("");if("string"==typeof a)this.$lyrics.append(a);else{this.currentText=void 0;var b=0,c;for(c in a){var d=a[c];if(d){var e=$("<li>"+d+"</li>");this.$lyrics.append(e);a[c]={index:b++,text:d}}}}},updateLyric:function(a){if("string"!=typeof a&&a&&(a=a[parseInt(this.$player[0].currentTime)])){var b=a.text;
...
$('<div class="stageContainer"></div>');this.SwiperContainer.append(this.searchResult);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.input);this.stage.append(this.searchButton);this.stage.append(this.searchPageSwiper);this.searchPageSwiper.css({"margin-top":"3px"});this.SwiperContainer.append(this.$matchType);this.SwiperContainer.append(this.searchSwiper);this.stage.append(this.SwiperContainer);
...
$("<div class='button'></div>");this.$button.attr("tabindex",0);this.$button.attr("role","button");this.$button.attr("aria-label",this.caption);this.ButtonClickEvent=this.onButtonClick.bind(this)},setCallback:function(a){this.callback=a},onButtonClick:function(a){var b=this,c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:if(BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),b.name,b.caption]))return g.return();c=buttonComponents[b.getClassName()];
if(!c||window[c]){g.jumpTo(2);break}g.setCatchFinallyBlocks(3);d=bookConfig.UIBaseURL+"javascript/component.min.js";return g.yield(loadComponents(d),5);case 5:initForms();resizeComponents();g.leaveTryBlock(2);break;case 3:e=g.enterCatchBlock(),console.error(e);case 2:global.activeButton=b.$button;b.onClick(a);b.executeCallback();b.hideTitle();if(a)return a.stopPropagation&&a.stopPropagation(),a.cancelBubble&&(a.cancelBubble=!0),g.return(!1);g.jumpToEnd()}})},onClick:virtual_function,executeCallback:function(){this.callback&&
...
Class("SelectTextButton",{create:function(){this._super();this.bindStates(this.setAsUnSelect,this.setAsSelect);this.initLanguage({btnSelectText:"Select Text"},{btnSelectText:"Select Text"});this.setAsUnSelect()},setAsSelect:function(){this.setSrc("text",bookConfig.SelectTextButtonIcon);this.changeColor("#bdc5e9");this.changeLanguage()},setAsUnSelect:function(){this.setSrc("text",bookConfig.SelectTextButtonIcon);this.changeColor();this.changeLanguage()},select:function(a){var b,c,d,e,g,f,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:b=
BookInfo.getCurrentPages(),c=0;case 2:if(!(c<b.length)){m.jumpTo(4);break}d=getSearchRealPageIndex(b[c]);if(-1==d){m.jumpTo(3);break}e=!1;for(g=0;g<positionForPages.length;g++)if(positionForPages[g]&&positionForPages[g].page&&positionForPages[g].page==d){e=!0;break}if(e){m.jumpTo(3);break}f=String.format(bookConfig.searchPositionJS,d);1<d&&(f=f.replace("[1]","["+d+"]"));h=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi;k=/\.*\/?(\w+\/)*\w+?\.js/gi;if(!f.match(h)&&!f.match(k)){m.jumpTo(4);break}return m.yield(getArticleImage(fixURLValue(f)),
6);case 6:f=m.yieldResult,loadJavascript(f,function(){},function(){});case 3:c++;m.jumpTo(2);break;case 4:BookInfo.getBook()&&BookInfo.getBook().select(),m.jumpToEnd()}})},unSelect:function(){BookInfo.getBook()&&BookInfo.getBook().unSelect()},onClick:function(){BookInfo.getBook()&&BookInfo.getBook().flipping||(this.status?(this.setAsUnSelect(),this.unSelect(),this.status=0):(this.setAsSelect(),this.select(),this.status=1))}}).extend("ToolbarStateButton");
...
!0},magnifierZoom:function(){BookInfo.getBook()&&BookInfo.getBook().magnifierZoom()},unMagnifierZoom:function(){BookInfo.getBook()&&BookInfo.getBook().unMagnifierZoom()},onClick:function(a){BookInfo.getBook().status_zoom||(global.canMagnifierZoom?(!bookConfig.MagnifierButtonVisible||global.magnifierZoomBox||global.isBelowIE11()||(global.magnifierZoomBox=new WindowMagnifierBox(tmpContainer)),this.setAsZoomin(),this.unMagnifierZoom()):(this.setAsZoomout(),this.magnifierZoom()))}}).extend("ToolbarStateButton");var getLogoLink=function(){return[bookConfig.appLogoLinkURL,bookConfig.appLogoOpenWindow]},initLogoBar=function(a){if(bookConfig.appLogoIcon){var b=$("#logoBar");b.html("");a=b.height();var c=bookConfig.logoHeight,d=bookConfig.logoPadding,e=["popular","courts"].includes(global.templeteName)?bookConfig.logoTop:parseInt((a-c)/2),g=getLogoLink(),f=$("<img style='position:absolute;left:0;top:0;'/>");f.attr({src:bookConfig.appLogoIcon});f.on("load",function(){b.html(f);f.css({height:c+"px",top:e+"px"});
b.css({left:d+"px",width:f[0].naturalWidth*c/f[0].naturalHeight+"px"});g[0]&&0>g[0].indexOf("javascript:void(0)")&&(f.click(function(){BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"logoImage","logo"]);if(!BookEvent.trigger("jumpLink",["logo",BookInfo.getCurrentPageIndex(),g[0]])){var h=getTarget();h="book_"+(void 0===h.uLink?"":h.uLink)+"_"+(void 0===h.bLink?"":h.bLink);h=g[0].includes("yunzhan365")||g[0].includes("fliphtml5")?appendParamToUrl(g[0],"i="+h):g[0];window.open(h,g[1])}}),
...
function getTarget(){var a=1,b=window.location.host;var c=window.location.pathname;var d="",e="";if(!window.yz_temp_link){if(b.match("www.yunzhan365.com")||b.match("test.yunzhan365.com")){if(b.match("www.yunzhan365.com/view"))return;a=c.indexOf("/",1)+1;var g=c.indexOf("/",a);var f=c.indexOf("/",g+1);d=c.substring(a,g);e=c.substring(g+1,f)}else if("book.yunzhan365.com"==b||"test2.yunzhan365.com"==b||"book.asflip.com"==b||"bookh.yunzhan365.com"==b||"online.fliphtml5.com"==b||"t.flipbuilder.com"==b)g=
c.indexOf("/",1),f=c.indexOf("/",g+1),d=c.substring(a,g),e=c.substring(g+1,f);try{/^https?:\/\/[^/]+\/books(?:\/|$)/.test(location.href)&&(g=c.indexOf("/",1),f=c.indexOf("/",g+1),d=window.userInfo.d,e=c.substring(g+1,f))}catch(h){}return{uLink:d,bLink:e}}}
...
h.nextAddress){if(isTouchDevice())return b="Chinese"==UserGroups?"https://mail.qq.com/":"http://gmail.google.com",setTimeout(function(){window.open(b,"_blank")},50),h.jumpTo(0);c=bookConfig.btnShareWithEmailBody;d=bookConfig.btnShareWithEmailSubject;e=bookConfig.btnShareWithEmailTo||"";d||(d="");g=share_url.substring(0,share_url.lastIndexOf("/"))+"/";return h.yield(getPageDir(1,"thumb"),3)}f=g+h.yieldResult;c=c.replaceAll("{thumb}",f,!0);c=c.replaceAll("{link}",share_url,!0);c=c.replaceAll("{title}",
...
Class("PCButtonQueue",{sort:function(){var a=this.buttonWidth+10,b=0;this.mostNum=this.buttons.length;var c=Math.floor((this.container.width-50)/a);this.buttons.length/2-parseInt(this.buttons.length/2)&&(this.mostNum+=1);c>Math.floor(this.mostNum/2)&&(c=Math.floor(this.mostNum/2));var d=c;a=Number.between(c+d,0,this.buttonCount);var e=50;a<this.buttonCount&&a--;for(var g=0;g<this.buttons.length;g++){var f=this.buttons.get(g);g<a?g<c?(f==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&
(VolumeControlBar.config.direction=VolumeControlBar.TOP,f.title=!1),"WeChatShareButton"==f.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.TOP),"TelephoneNumberButton"==f.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.TOP),f.addTo(this.container.body),f.setPosition(e,this.buttonTop),e+=this.buttonWidth+10):(f==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.TOP,f.title=!1),"WeChatShareButton"==
f.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.TOP),"TelephoneNumberButton"==f.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.TOP),f.addTo(this.containerRight.body),b=50*parseInt(2*d-g),f.$button.css({right:b+"px",top:this.buttonTop+"px",left:"auto"})):(f==this.buttons.find("sound").get(0)&&bookConfig.BackgroundSoundURL&&(VolumeControlBar.config.direction=VolumeControlBar.DEFAULT,f.title=!1),"WeChatShareButton"==f.getClassName()&&global.WeChatShareImg.setDirection(TextBubble.LEFT),
"TelephoneNumberButton"==f.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),f.addTo(this.extended),f.$button.css({background:"transparent"}),f.title&&(f.title.direction=TextBubble.LEFT,f.title.arrowWidth=4,f.title.arrowHeight=8))}c=windowWidth-210;a<this.buttonCount&&(b=50>=b-50?45>this.containerRight.width?10:50:b-50,this.btnMore.$button.css({top:this.buttonTop+"px",right:b+"px"}),this.btnMore.title&&(this.btnMore.title.direction=TextBubble.RIGHT,this.btnMore.title.arrowWidth=
...
this.btnPrevious.$button.css({display:"block"}),this.btnNext.$button.css({display:"block"}));334>=c&&(this.btnFirst.$button.css({display:"none"}),this.btnLast.$button.css({display:"none"}),this.btnBackward&&this.btnBackward.$button.css({display:"none"}),this.btnForward&&this.btnForward.$button.css({display:"none"}),this.btnPrevious.$button.css({display:"none"}),this.btnNext.$button.css({display:"none"}));this.addPageButtons()},addPageButtons:function(){function a(l){l.addTo(e);l.setPosition(g,h);
g+=f+10}function b(){edtPageNumberLeft=(d-m)/2;k.css({left:edtPageNumberLeft+"px",top:"-40px",width:m+"px",display:"block"});k.find("input").css({width:m+"px"})}var c=4;bookConfig.enablePageBack&&(c+=2);var d=this.pageContainer.width,e=this.pageContainer.body,g=Math.floor((d-(2*this.edtNumber.space+c*(this.buttonWidth+10)-10))/2)+4,f=this.buttonWidth,h=this.edtNumber.top-15,k=this.edtNumber.body,m=this.edtNumber.width;rightToLeft?(bookConfig.enablePageBack&&a(this.btnForward),a(this.btnLast),a(this.btnNext),
...
this.pageBar=$("<div class='pageBar' ></div>");this.boardBar=$("<div class='fbBoardBar' id='fbBoardBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'><label><input aria-labelledby='currentPageIndex' autocomplete='off' type='text' class='inputInnerShadow' id='currentPageIndexTextField' /></label><span class=\"editNumBevel\"></span></div>");this.parent.append(this.topBar);this.parent.append(this.boardBar);this.parent.append(this.bottomBar);this.topBar.append(this.logoBar);
this.bottomBar.append(this.pageBar);this.bottomBar.append(this.buttonBar);this.bottomBar.append(this.buttonBarRight);this.pageBar.append(this.edtPageNumber);this.initPageNumber();this.initBoard()},initBoard:function(){this.bottomBar.css({"border-bottom":"5px solid "+this.color.rgba(this.topBarAlpha)});this.boardBar.css({"border-bottom":"35px solid "+Color(this.color).rgba(.7*this.topBarAlpha)})},initPageNumber:function(){this.edtPageNumber.css({background:this.color.rgba(.7)});var a=this.edtPageNumber.find("input"),
...
function core_hx(a,b){a[b>>5]|=128<<b%32;a[(b+64>>>9<<4)+14]=b;b=1732584193;for(var c=-271733879,d=-1732584194,e=271733878,g=0;g<a.length;g+=16){var f=b,h=c,k=d,m=e;b=hx_ff(b,c,d,e,a[g+0],7,-680876936);e=hx_ff(e,b,c,d,a[g+1],12,-389564586);d=hx_ff(d,e,b,c,a[g+2],17,606105819);c=hx_ff(c,d,e,b,a[g+3],22,-1044525330);b=hx_ff(b,c,d,e,a[g+4],7,-176418897);e=hx_ff(e,b,c,d,a[g+5],12,1200080426);d=hx_ff(d,e,b,c,a[g+6],17,-1473231341);c=hx_ff(c,d,e,b,a[g+7],22,-45705983);b=hx_ff(b,c,d,e,a[g+8],7,1770035416);
e=hx_ff(e,b,c,d,a[g+9],12,-1958414417);d=hx_ff(d,e,b,c,a[g+10],17,-42063);c=hx_ff(c,d,e,b,a[g+11],22,-1990404162);b=hx_ff(b,c,d,e,a[g+12],7,1804603682);e=hx_ff(e,b,c,d,a[g+13],12,-40341101);d=hx_ff(d,e,b,c,a[g+14],17,-1502002290);c=hx_ff(c,d,e,b,a[g+15],22,1236535329);b=hx_gg(b,c,d,e,a[g+1],5,-165796510);e=hx_gg(e,b,c,d,a[g+6],9,-1069501632);d=hx_gg(d,e,b,c,a[g+11],14,643717713);c=hx_gg(c,d,e,b,a[g+0],20,-373897302);b=hx_gg(b,c,d,e,a[g+5],5,-701558691);e=hx_gg(e,b,c,d,a[g+10],9,38016083);d=hx_gg(d,
e,b,c,a[g+15],14,-660478335);c=hx_gg(c,d,e,b,a[g+4],20,-405537848);b=hx_gg(b,c,d,e,a[g+9],5,568446438);e=hx_gg(e,b,c,d,a[g+14],9,-1019803690);d=hx_gg(d,e,b,c,a[g+3],14,-187363961);c=hx_gg(c,d,e,b,a[g+8],20,1163531501);b=hx_gg(b,c,d,e,a[g+13],5,-1444681467);e=hx_gg(e,b,c,d,a[g+2],9,-51403784);d=hx_gg(d,e,b,c,a[g+7],14,1735328473);c=hx_gg(c,d,e,b,a[g+12],20,-1926607734);b=hx_hh(b,c,d,e,a[g+5],4,-378558);e=hx_hh(e,b,c,d,a[g+8],11,-2022574463);d=hx_hh(d,e,b,c,a[g+11],16,1839030562);c=hx_hh(c,d,e,b,a[g+
14],23,-35309556);b=hx_hh(b,c,d,e,a[g+1],4,-1530992060);e=hx_hh(e,b,c,d,a[g+4],11,1272893353);d=hx_hh(d,e,b,c,a[g+7],16,-155497632);c=hx_hh(c,d,e,b,a[g+10],23,-1094730640);b=hx_hh(b,c,d,e,a[g+13],4,681279174);e=hx_hh(e,b,c,d,a[g+0],11,-358537222);d=hx_hh(d,e,b,c,a[g+3],16,-722521979);c=hx_hh(c,d,e,b,a[g+6],23,76029189);b=hx_hh(b,c,d,e,a[g+9],4,-640364487);e=hx_hh(e,b,c,d,a[g+12],11,-421815835);d=hx_hh(d,e,b,c,a[g+15],16,530742520);c=hx_hh(c,d,e,b,a[g+2],23,-995338651);b=hx_ii(b,c,d,e,a[g+0],6,-198630844);
e=hx_ii(e,b,c,d,a[g+7],10,1126891415);d=hx_ii(d,e,b,c,a[g+14],15,-1416354905);c=hx_ii(c,d,e,b,a[g+5],21,-57434055);b=hx_ii(b,c,d,e,a[g+12],6,1700485571);e=hx_ii(e,b,c,d,a[g+3],10,-1894986606);d=hx_ii(d,e,b,c,a[g+10],15,-1051523);c=hx_ii(c,d,e,b,a[g+1],21,-2054922799);b=hx_ii(b,c,d,e,a[g+8],6,1873313359);e=hx_ii(e,b,c,d,a[g+15],10,-30611744);d=hx_ii(d,e,b,c,a[g+6],15,-1560198380);c=hx_ii(c,d,e,b,a[g+13],21,1309151649);b=hx_ii(b,c,d,e,a[g+4],6,-145523070);e=hx_ii(e,b,c,d,a[g+11],10,-1120210379);d=hx_ii(d,
e,b,c,a[g+2],15,718787259);c=hx_ii(c,d,e,b,a[g+9],21,-343485551);b=safe_add(b,f);c=safe_add(c,h);d=safe_add(d,k);e=safe_add(e,m)}return[b,c,d,e]}function hx_cmn(a,b,c,d,e,g){return safe_add(bit_rol(safe_add(safe_add(b,a),safe_add(d,g)),e),c)}function hx_ff(a,b,c,d,e,g,f){return hx_cmn(b&c|~b&d,a,b,e,g,f)}function hx_gg(a,b,c,d,e,g,f){return hx_cmn(b&d|c&~d,a,b,e,g,f)}function hx_hh(a,b,c,d,e,g,f){return hx_cmn(b^c^d,a,b,e,g,f)}function hx_ii(a,b,c,d,e,g,f){return hx_cmn(c^(b|~d),a,b,e,g,f)}
...
"\u542c\u4e66")+"</span></div>");var g=$("<span></span>");g.css({display:"inline-block",position:"absolute",top:"-4px",left:"9px",width:"0",height:"0","border-bottom":"4px solid "+b.rgba(d),"border-left":"4px solid transparent","border-right":"4px solid transparent"});c=c?c:getLanguage("btnPhoneticTips","\u672c\u4e66\u53ef\u4ee5\u8fb9\u542c\u8fb9\u770b\u54e6~");var f=$("<div class='phoneticTips'><span>"+c+"</span></div>");f.append(g);f.css({display:"none",position:"absolute",top:"40px",left:"10px",
padding:"5px",width:"130px","line-height":"24px","background-color":b.rgba(d),"border-radius":"2px","font-size":"12px","font-weight":"500","text-align":"center"});f.delay(3E3).fadeIn(200).delay(1E3*a).fadeOut(200);f.click(function(){f.stop().fadeOut(200)});e.append(f);document.querySelector(".toolbar_head")||(a=$("<div class='toolbar_head'></div>"),a.css("color",bookConfig.iconColor),tmpContainer.append(a));$(".toolbar_head").append(e);e.changeButtonColor(bookConfig.iconColor);e.css({"background-color":b.rgba(d)});
...
function onWindowKeyDown(a){if(a){var b=a.keyCode;if(b===KEY_CODE_LEFT||b===KEY_CODE_RIGHT){var c=a.target,d,e=null==(d=c.tagName)?void 0:d.toLowerCase();if(c.isContentEditable||"input"===e||"textarea"===e||"div"===e&&"true"===c.getAttribute("contenteditable"))return}if(!fullScreenApi.isFullScreen()||fullScreenApi.srcElement==$("body")[0])if(Log.info("key down[%d]",b),b===KEY_CODE_ESC){var g;null==(g=FormManager)||g.closeTop()}else{if(b==KEY_CODE_LEFT||b==KEY_CODE_PAGEUP)rightToLeft?nextPageFun("key down"):
...
function getArticleImage(a){return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){a=changeBookResourceBaseURL(a);return bookConfig.isEncryptionBook?b.return(new Promise(function(c,d){var e=[];e.push(toAbsURL(a));d=BookRestrict.getRestrictToken();$.ajax({type:"get",url:restrictUrl,dataType:"json",data:{urls:JSON.stringify(e),token:d},success:function(g){"OK"==g.code?c(g.data[e[0]]):c("")},error:function(){c("")}})})):b.return(a)})}
function set_weixin_share(a,b,c,d){if("micromessenger"==window.navigator.userAgent.toLowerCase().match(/MicroMessenger/i)){var e=a,g=b,f="https:"+d.replace(/^https?:/,"").replace(/\?[0-9]*/,"");e=""==e?c:e;g=""==g?e:g;g=g.replace(/<br>/g,"\n");wx.ready(function(){wx.onMenuShareWeibo({title:e,desc:""==g?e:g,link:c,imgUrl:f,success:function(){},cancel:function(){}});wx.onMenuShareTimeline({title:e,link:c,imgUrl:f,success:function(){},cancel:function(){}});wx.onMenuShareAppMessage({title:e,desc:g,link:c,
imgUrl:f,success:function(){},cancel:function(){}});wx.onMenuShareQQ({title:e,desc:g,link:c,imgUrl:f,success:function(){},cancel:function(){}});wx.onMenuShareWeibo({title:e,desc:g,link:c,imgUrl:f,success:function(){},cancel:function(){}});try{wx.onMenuShareWechat({title:e,desc:g,link:c,imgUrl:f,success:function(){},cancel:function(){}})}catch(h){}wx.invoke("shareAppMessage",{title:e,desc:g,link:c,imgUrl:f},function(h){});wx.invoke("shareWechatMessage",{title:e,desc:g,link:c,imgUrl:f},function(h){});
wx.invoke("shareToExternalContact",{title:e,desc:g,link:c,imgUrl:f},function(h){});wx.invoke("shareToExternalChat",{title:e,desc:g,link:c,imgUrl:f},function(h){})});wx.error(function(h){})}}function loadGlobalArticleConfig(a){loadArticleConfig(a)}
